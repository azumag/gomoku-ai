...
# MNISTデータの読み込み
print "--- データの読み込み開始 ---"
histories = csv.reader(open('/home/azumagakito/gomoku-ai/ai/tmp/h-inf3', 'r'))
answs = csv.reader(open('/home/azumagakito/gomoku-ai/ai/tmp/a-inf3', 'r'))
...
saver.save(sess, '/home/azumagakito/gomoku-ai/ai/lv11/model/4layer.ckpt')
