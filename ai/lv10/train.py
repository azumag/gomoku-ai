...
# MNISTデータの読み込み
print "--- データの読み込み開始 ---"
histories = csv.reader(open('/home/azumagakito/gomoku-ai/ai/tmp/h-inf2', 'r'))
answs = csv.reader(open('/home/azumagakito/gomoku-ai/ai/tmp/a-inf2', 'r'))
...
saver.save(sess, '/home/azumagakito/gomoku-ai/ai/lv10/model/4layer.ckpt')
